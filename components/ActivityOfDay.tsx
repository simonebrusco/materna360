export default function ActivityOfDay() {
  return (
    <div>
      ...
      <p className="mt-1.5 text-gray-600 leading-relaxed">Separe alguns blocos de montar e convide seu filho para criar juntos uma torre, um animal ou o que a imaginação mandar.</p>
