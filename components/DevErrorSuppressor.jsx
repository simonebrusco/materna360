...
export default function DevErrorSuppressor() {
  useEffect(() => {
    // In dev, we avoid monkey-patching window.fetch because that can interfere with
    // Next.js dev client (RSC/HMR). Instead, rely on global error handlers below
    // to suppress noisy FullStory fetch errors.
