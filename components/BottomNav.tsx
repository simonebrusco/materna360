...
export default function BottomNav() {
  ...
  return (
    <nav className="sticky bottom-0 z-20 border-t border-gray-200 bg-white/80 backdrop-blur supports-[backdrop-filter]:bg-white/60 pb-6 [padding-bottom:env(safe-area-inset-bottom)]">
