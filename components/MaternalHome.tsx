...
import HomeQuadGrid from "@/components/HomeQuadGrid";
...
export default function MaternalHome({ flags: incomingFlags }: { flags?: Record<string, any> }){
  ...
  return (
    <div className={`m360-container meu-dia${flags.newHomeMaternal ? ' hub' : ''}`}>
      ...
      <section aria-labelledby="section-quick-actions" className="mt-6">
        <h2 id="section-quick-actions" className="sr-only">Quick Actions</h2>
        <HomeQuadGrid />
      </section>
