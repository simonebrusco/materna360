...
export function showToast(arg = "", opts = {}) {
  ...
  const duration = typeof (opts.duration ?? payload.duration) === "number" ? (opts.duration ?? payload.duration) : 3000;
  ...
  useEffect(() => {
    function onToast(e) {
      ...
      const t = {
        ...
        duration: typeof e?.detail?.duration === "number" ? e.detail.duration : 3000,
      };
