// Content recommendations for Discover page (JS-only)
// Export a product catalog by category and age group

/** @typedef {{ title: string, image: string, url: string, tag?: string, blurb?: string }} Product */

/** @type {Record<string, Record<"0-2"|"3-4"|"5-7"|"8+", Product[]>>} */
