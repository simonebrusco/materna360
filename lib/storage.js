...
// ---- Badges map helpers (merge, never overwrite) ----
export function getBadgesMap(){ return get(`m360:badges`, {} ) || {}; }
export function upsertBadges(patch){
  try{
    const base = getBadgesMap();
    const next = { ...(base && typeof base==='object' ? base : {}), ...(patch && typeof patch==='object' ? patch : {}) };
    set(`m360:badges`, next);
    return next;
  }catch{ return getBadgesMap(); }
}
