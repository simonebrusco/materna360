      ...
      <div className="space-y-6">
        ...
        >
          ...
          <ActivityOfDay
            ...
            secondaryButtonClassName="bg-transparent ring-1 ring-[color:var(--brand-coral)] text-[color:var(--brand-navy)] rounded-md px-3.5 py-2 font-semibold hover:bg-white focus:outline-none focus:ring-2 focus:ring-[color:var(--brand-coral)]/40 focus:ring-offset-2"
